...
onNet(PhoneEvents.SEND_CREDENTIALS, (number: string, playerSource: number, identifier: string) => {
  ...
  sendMessage('PHONE', PhoneEvents.SEND_PLAYER_IDENTIFIER, Number(identifier));
});
